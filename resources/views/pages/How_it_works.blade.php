...
<main>
    ...
    <div class="services-area">
        ...
        <div c           lass="row justify-content-center">
                                          <div class="col-12">
    ...
    <svg class="desk-roadmap" width="1440px" height="400px" viewBox="0 0 1440 400" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
                ...
                <g id="roadmap" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(0,3)">
                    ...
                    <foreignObject class="roadmap-text node" x="316.5" y="150">
                        <div class="">Discovery Meeting</div>                
                    </foreignObject>
                    <foreignObject class="roadmap-text node" x="475" y="118.50000" >
                        <div class="roadmap-text">Develop an Investment Policy Statement</div>                
                    </foreignObject>
                    <foreignObject class="roadmap-text node" x="625" y="100" >
                        <div class="roadmap-text">Assess and Analyze</div>                
                    </foreignObject>
                    <foreignObject class="roadmap-text node" x="768" y="75" >
                        <div class="roadmap-text">Design an Investment Strategy</div>                
                    </foreignObject>
                    <foreignObject class="roadmap-text node" x="900" y="44.5" >
                        <div class="roadmap-text">Propose Planning and Recommendations</div>                
                    </foreignObject>
                    <foreignObject class="roadmap-text node" x="1050.5" y="25.5" >
                    ...
                    <!-- Click icon -->
                    <g transform="translate(366.500000, 227.00000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(339.000000, 197.000000)" class="desc-container container-2">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(511.00000, 218.50000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(485, 189.5)" class="desc-container container-3">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(654.00000, 188.50000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(626, 157.5)" class="desc-container container-4">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(798.00000, 177.00000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(772, 148)" class="desc-container container-5">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(942.00000, 146.50000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(914, 117.5)" class="desc-container container-6">
                    ...
                    <g transform="translate(1086.50000, 137.50000)" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!-- Click icon -->
                    <g transform="translate(1058.5, 105.5)" class="desc-container container-7">
            ...
            <div class="p-5 desk-roadmap">
                ...
                <div id="" class="services position-2" style="margin-top: -130px;">
                    <div class="container">
                                ...
                                <div class="icon-boxes d-flex flex-column justify-content-center">
                                    <div class="d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                                        <div class="icon-box iconbox-teal">
                                            ...
                                            <p>
                                                Analyse all areas of your financial life: <br>
                                                    • Cash Flow management <br> 
                                                        • Insurance and Protection Planning<br> 
                                                                ...
                                                                • Asset Management <br>
                                                                    • Retirement Planning <br>
                                                                        ...
                                                                        <br> • Tax Planning</p>
                                                                            ...
                                                                            <div id="" style="margin-top: -160px;" class="services position-5">
                                                                                <div class="container">
                                                                            ...
                                                                            <div id="" class="services position-6" style="margin-top: -200px;">
                                                                                <div class="container">
                                                                                    <div class="section-title">
                                                                                        <br>
                                                                                    </div>
                                                                            ...
                                                                            <div id="" class="services position-7" style="margin-top: -200px;">
                                                                                <div class="container">
                                                                                    <div class="section-title">
                                                                                        <br>
                                                                                    </div>
                                                                            ...
                                                                            <div id="" class="services position-8">
                                                                                <div class="container">
                                                                                    <div class="section-title">
                                                                                        <br>
                                                                                    </div>
                                                                            ...
                                                                            <div id="" class="services position-9" style="margin-bottom: 60px;">
                                                                                <div class="container">
                                                                                    <div class="section-title">
                                                                                        <br>
                                                                                    </div>
