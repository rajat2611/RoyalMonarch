                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-lg-2 career_perk mb-70">                        
                        <div class="col-md-4 align-self-center">
                            ...
                            <p>Enjoy the ability to take as much personal and vacation time as needed with advance approval. Sometimes people work from Home</p>
                        </div>                                    
                        <div class="col-md-4 align-self-center">
                            <img src="{{asset('image/Career/We-have-got-you-covered.png')}}" width="25" style="float:left">
                            <h5>We’ve got you</h5>
                            <p>Our benefits include comprehensive healthcare, a great retirement plan, backup childcare, education stipends and so much more.</p>
                        </div>
                        <div class="col-md-4 align-self-center">
