...
Route::group(['prefix' => 'admin', 'middleware' => ['web', 'isAdmin']], function () {
    ...
    Route::get('author/add', 'AdminController@authorAdd');
    Route::post('author/post', 'AdminController@authorSave');
    Route::post('author/update/{author}', 'AdminController@authorUpdate');
    Route::get('author/edit/{id}', 'AdminController@editAuthor');
    Route::get('author/delete', 'AdminController@deleteAuthor');
    Route::get('contacts', 'AdminController@contacts');
    Route::get('contact/{id}', 'AdminController@contactsDetails');
    Route::get('contacts/changestatus', 'AdminController@contactStatus');
    
    Route::get('customer/lead','AdminController@cutomerLead');
    Route::get('customer/status','AdminController@cutomerLeadStatus');
    Route::get('customer/view/{id}','AdminController@viewcutomerLead');
